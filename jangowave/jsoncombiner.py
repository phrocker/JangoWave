  ...
  def seek(self,iterator, range, families, inclusive):
    ...
    if ("fi" in start_key.getColumnFamily().toString()):
      ...
      if (iterator.hasTop()):
        ...
        nk = AccumuloKey(key.getRow(),cqsplit[1] + "\x00" + cqsplit[2])
      ...
      if (iterator.hasTop()):
        ...
        skip_key = Key(topkey.getRow(),topkey.getColumnFamily(),topkey.getColumnQualifier(),topkey.getColumnVisibility(),topkey.getTimestamp())
